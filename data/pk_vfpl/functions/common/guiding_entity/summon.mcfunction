...
summon wandering_trader ~ 1000 ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,Tags:["pk_vfpl_guiding_entity","pk_vfpl_current_guiding_entity","pk_vfpl_exclude"],active_effects:[{id:"minecraft:invisibility",amplifier:1b,duration:2147483647,show_particles:0b}],Offers:{Recipes:[]}}
