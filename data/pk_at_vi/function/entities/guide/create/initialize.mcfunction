...
# Set data
data merge entity @s {Silent:1b,Invulnerable:true,Offers:{Recipes:[{buy:{id:"barrier",count:1},sell:{id:"barrier",count:1}}]},attributes:[{id:"scale",base:0.0625}],active_effects:[{id:"invisibility",show_particles:false,duration:-1,amplifier:0}]}